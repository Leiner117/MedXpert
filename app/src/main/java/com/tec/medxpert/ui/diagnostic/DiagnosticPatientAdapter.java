...
public class DiagnosticPatientAdapter extends RecyclerView.Adapter<DiagnosticPatientAdapter.ViewHolder> {

    private List<Diagnostic> diagnostics;
    private DiagnosticCoordinator coordinator;

    public DiagnosticPatientAdapter(List<Diagnostic> diagnostic, DiagnosticCoordinator coordinator) {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.diagnosticNameTextView.setText(diagnostic.getConsultation_reason());
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        TextView diagnosticNameTextView, idTextView, dateTextView;
        ImageView chevronIcon;

        public ViewHolder(View itemView) {
            super(itemView);
            diagnosticNameTextView = itemView.findViewById(R.id.diagnosticNameTextView);
